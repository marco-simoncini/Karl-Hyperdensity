...
rg_excludes=(
  ...
  --glob "!**/RESOURCELEASE_TP_FREEZE_CANDIDATE.md"
  --glob "!**/RESOURCELEASE_PROJECTION_FREEZE_CANDIDATE.md"
  --glob "!**/RESOURCELEASE_OBSERVATION_FREEZE_CANDIDATE.md"
  --glob "!**/RESOURCELEASE_ISO_FREEZE_CANDIDATE.md"
  --glob "!**/RESOURCEPORT_TP_FREEZE_CANDIDATE.md"
  --glob "!**/NATIVE_LIVE_TP_FREEZE_CANDIDATE.md"
