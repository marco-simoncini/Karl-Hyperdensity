...
**Sprint 67** adds **staged wrappers** for apply observation in Dashboard (`apply_observation_wiring_v1.go`). **`apply.go` does not call wrappers yet.** All runtime flags remain **false**.
