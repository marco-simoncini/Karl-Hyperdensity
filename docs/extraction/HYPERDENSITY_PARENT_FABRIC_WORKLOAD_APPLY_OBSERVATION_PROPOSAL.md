...
**Sprint 65** is **proposal-only**: inventory and criteria for a future **`ApplyObservationWiredV1`** phase. **`apply.go` remains legacy.** No runtime wiring. Hyperdensity receives **no** new Go adapter code.
