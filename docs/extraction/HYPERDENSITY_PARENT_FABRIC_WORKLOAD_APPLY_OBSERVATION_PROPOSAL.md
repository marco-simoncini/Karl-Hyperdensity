...
**Sprint 65** is **proposal-only**: inventory and criteria for a future **`ApplyObservationWiredV1`** phase. **Sprint 66** shadow matrix. **Sprint 67** staged wrappers. **Sprint 68** wrapper hardening. **`apply.go` remains legacy.** No runtime wiring. Hyperdensity receives **no** new Go adapter code.
