...
**Sprint 66** designs and validates the **shadow matrix** for the four `apply.go` legacy observation call sites. **No runtime wiring.** **`apply.go` remains legacy.** Candidate helpers exist for test/shadow only.
