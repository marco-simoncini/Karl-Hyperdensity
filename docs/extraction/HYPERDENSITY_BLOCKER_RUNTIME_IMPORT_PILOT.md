...
Consumers pin tagged module **`v0.1.9-khr-m1-m19`** (Sprint 39 `DashboardRequiredTokens` + Sprint 40 no-republish / superseded-version hygiene; runtime remains `blockers` only per M17).
