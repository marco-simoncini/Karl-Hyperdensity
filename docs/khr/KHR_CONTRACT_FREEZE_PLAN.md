...
|------|-----------|------------------------|
| **TP freeze** | `khr-projection-v1alpha1-readonly-y`, `khr-tp-readiness-summary-v1alpha1`, Host/Shell/Cell/ResourcePort/ResourceFuture CRDs + docs, **ResourceLease CRD/schema/projection (KHR-AE)**, **ResourcePort + native-live lane semantics (KHR-AF)**, **Scope-4 guarded-apply certification fields (KHR-BF)**, **Scope-4 operational governance fields (KHR-BG)**, Inventory posture schema (read-only fields) | Additive fields only; no removals; no semantic change to `readOnly: true` |
...
3. **Evidence anchor files** (`certification-summary.json`, registry/provenance summaries, **scope4 guarded-apply certification summary (KHR-BF)**, **scope4 governance summary (KHR-BG)**).
