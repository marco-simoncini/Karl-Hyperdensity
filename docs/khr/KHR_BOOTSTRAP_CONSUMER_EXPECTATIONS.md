...
| Field | Value |
|-------|-------|
| **Sprint** | KHR-AG / KHR-AH / KHR-AI / KHR-AJ / **KHR-AK** |
...
| **Karl-Installer** | karl2 CRD apply+verify + skew guard (`khr-tp-contract-v1`) | `docs/evidence/khr-installer-crd-foundation/`; `crdDiffEmpty` |
| **Karl-Hyperdensity** | `docs/contracts/khr/khr-contract-manifest.yaml` | Canonical `expectedCrds` + freeze candidates |
